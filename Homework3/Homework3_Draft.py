...
# Extracting educational level, industrial sector, and socio economic status as explanatory variables
X1 = cses[['D2012', 'D2014']].to_numpy()
X1 = X1.astype(float)
for i in range(6,10):
	X1[X1==i] = np.nan
...
grid_logreg = GridSearchCV(logreg, {'C':[0.001, 0.01, 0.1, 1, 10, 100]}, cv=7)
